...
define config.main_menu_music = "music/Date at noon.mp3"
...
define config.save_directory = "TTW-1576574382"
...
init python:
    setattr(config, "mouse", {"default": [("images/other/cursor.png", 0, 0) ]})
